"""Prompts for graph question answering.
...
CYPHER_QA_TEMPLATE = """You are an assistant that helps to form nice and \
human understandable answers.
The information part contains the provided information that you must use to \
construct an answer.
